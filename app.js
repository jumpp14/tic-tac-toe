$(document).ready(function() {
  $(".dots").click(function() {
    ...
    if (ifDifChosen == true) {
      ...
      $(".twoModes, .chooseCol").css("visibility", "hidden");
    }
    else {
  ...
  $(".dial").knob({
    'release' : function () {
      dif = $("input").attr("value") * 0.01;
      if (ifColChosen == true) {
        $("td").css("visibility", "visible");
        $(".twoModes, .chooseCol").css("visibility", "hidden");
        $("input, .chooseDiff, .dial, canvas").css("visibility", "hidden");
      }
      else {
...
var ifColChosen = false;
var ifDifChosen = false;
var dif = 1;
